...
판서모드에서
Ctrl + 드레깅 : 사각형 그리기 ( 기본 선 속성 + 팬 또는 마커의 색상 이용  )
Ctrl + Shift + 드레깅 :  채운 사각형 그리기 (채움은 펜 또는 마커의 색상 이용 )
Alt + 드레깅 : 원 그리기 ( 기본 선 속성 + 팬 또는 마커의 색상 이용  )
Alt + Shift + 드레깅 : 채운 원 그리기 (채움은 펜 또는 마커의 색상 이용 )
Ctrl + Alt + 드레깅 : 선 그리기 (기본 선 속성 + 펜 또는 마커의 색상 이용)
```
