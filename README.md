...
판서모드 + Ctrl + 드레깅 : 사각형 그리기
판서모드 + Ctrl + Shift + 드레깅 :  채운 사각형 그리기 (펜 또는 마커의 색상 이용, 변경은 채우기 스타일 이용)
판서모드 + Alt + 드레깅 : 원 그리기 ( 기본 선 속성에 따름 )
판서모드 + Alt + Shift + 드레깅 : 채운 원 그리기 (채움은 펜 또는 마커의 색상 이용, 변경은 채우기 스타일 이용)
판서모드 + Ctrl + Alt + 드레깅 : 선 그리기 (기본 색상은 현재 펜 또는 마커의 색상 이용)
